...
extras:
  - title: Smart Home Energy Optimizer
    subtitle: Batteries, water heater and heat pump scheduled together against solar output, tariffs and grid limits by Dantzig–Wolfe decomposition, with a certified gap to the optimum. Drag the prices and household load to set your own. Runs entirely in the browser.
